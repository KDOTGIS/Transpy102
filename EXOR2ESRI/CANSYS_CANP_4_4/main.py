...
import arcpy
from CONFIG import ws, EXOR_PROD, STAGEDB, nowish
...
incrnd = EXOR_PROD+"\\CRND"
insrnd = EXOR_PROD+"\\SRND"
...
arcpy.FeatureClassToGeodatabase_conversion("CRND",STAGEDB) #10 sec
arcpy.FeatureClassToGeodatabase_conversion("SRND",STAGEDB)  #9 sec
